...
- [Real-ESRGAN](https://github.com/xinntao/Real-ESRGAN): optional official general-x4v3 and general-wdn-x4v3 checkpoints from the [v0.2.5.0 release](https://github.com/xinntao/Real-ESRGAN/releases/tag/v0.2.5.0). See upstream license and model documentation. Downloading is an explicit user action and files are checksum-verified.
